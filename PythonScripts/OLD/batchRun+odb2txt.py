...
for job in jobNames: 
	...
	sensor1 = WavePropagationStep.historyRegions['Node RECTANGULARBEAM-1.13']
	sensor2 = WavePropagationStep.historyRegions['Node RECTANGULARBEAM-1.17']
	sensor3 = WavePropagationStep.historyRegions['Node RECTANGULARBEAM-1.21']
	sensor4 = WavePropagationStep.historyRegions['Node RECTANGULARBEAM-1.26']
