...
for job in jobNames: 
	...
	sensor1 = WavePropagationStep.historyRegions['Node PART132RAIL-1.5']
	sensor2 = WavePropagationStep.historyRegions['Node PART132RAIL-1.6']
	sensor3 = WavePropagationStep.historyRegions['Node PART132RAIL-1.7']
	sensor4 = WavePropagationStep.historyRegions['Node PART132RAIL-1.8']
